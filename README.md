...
# 📖 TVMAZE Movie Site<a name="about-project"></a>

This Project is about building a web application based on an external API that provides data about a TVMAZE which displays movie. The webapp will have 3 interfaces
to display the movies the comment section and the reservation part
...
Clone this repository to your desired folder:  cd my-folder  git clone git @https://github.com/bronnie313/JavaScript-Capstone.git
...
This project is [MIT](https://github.com/bronnie313/JavaScript-Capstone/tree/structureds) licensed.
